<%@ Page Title="" Language="C#" MasterPageFile="~/YoneticiPaneli/yoneticipnl.Master" AutoEventWireup="true" CodeBehind="oyuncuDuzenle.aspx.cs" Inherits="MovieStallWebApp.YoneticiPaneli.oyuncuDuzenle" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="formTasiyici">
        ...
        <div class="formBaslik">
            <h4>Oyuncunun Bilgilerini Düzenle</h4>
        </div>
        ...
        <div class="formIcerik">
            <div>
                <div style="float: left; width: 350px;">
                    ...
                    <div class="satir">
                        <label>İsmi</label><br />
                        <asp:TextBox ID="tb_oyuncuAdi" runat="server" CssClass="metinkutu"></asp:TextBox><br />
                    </div>

                    <div class="satir">
                        <label>Soyismi</label><br />
                        <asp:TextBox ID="tb_oyuncuSoyismi" runat="server" CssClass="metinkutu"></asp:TextBox><br />
                    </div>
            ...
            <div class="satir">
                <asp:LinkButton ID="lbtn_oyuncuDuzenle" runat="server" CssClass="islembuton" OnClick="lbtn_oyuncuDuzenle_Click">Oyuncu Bilgilerini Düzenle</asp:LinkButton>
                <asp:Label ID="lbl_bilgi" runat="server" CssClass="bilgipaneli" Visible="false">Oyuncu Başarılı Şekilde Düzenlendi</asp:Label>
            </div>
        </div>
    </div>
</asp:Content>